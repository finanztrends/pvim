...
highlight Pmenu ctermbg=24 ctermfg=15 gui=bold
...
" Gitlab Repo
let g:fugitive_gitlab_domains = ['https://gitlab.yes-investmedia.de']
let g:gitlab_api_keys = {'gitlab.yes-investmedia.de': 'ScUBirghuCDXLwSASxV5'}
